...
tasks.register<Jar>("buildPluginJar") {
    archiveFileName.set("boss-plugin-keyboard-shortcut-explorer-${version}.jar")
    duplicatesStrategy = DuplicatesStrategy.EXCLUDE
    manifest {
        attributes(
            "Implementation-Title" to "BOSS Keyboard Shortcut Explorer Plugin",
            "Implementation-Version" to version,
            "Main-Class" to "ai.rever.boss.plugin.dynamic.shortcuts.ShortcutsDynamicPlugin",
        )
    }
